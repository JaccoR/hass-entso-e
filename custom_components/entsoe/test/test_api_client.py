...
from entsoe.api_client import EntsoeClient
...
class TestDocumentParsing(unittest.TestCase):
    ...
    def test_be_60m(self):
        with open("test/datasets/BE_60M.xml") as f:
            data = f.read()

        self.assertDictEqual(self.client.parse_price_document(data), {
    ...
    def test_be_60m_15m_mix(self):
        with open("test/datasets/BE_60M_15M_mix.xml") as f:
            data = f.read()
        ...
        self.assertDictEqual(self.client.parse_price_document(data), {
            ...
            datetime.fromisoformat("2024-10-06T12:00:00Z"): -0.01, # repeated value, not present in the dataset!
