...
from .const import CONF_COORDINATOR, CONF_EXCHANGE_RATE_ID, CONF_VAT_VALUE, DOMAIN, CONF_API_KEY, CONF_AREA, CONF_MODIFYER, DEFAULT_MODIFYER
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    exchange_rate_id = entry.options.get(CONF_EXCHANGE_RATE_ID)
    entsoe_coordinator = EntsoeCoordinator(hass, api_key=api_key, area = area, modifyer = modifyer, VAT=vat, exchange_rate_id=exchange_rate_id)
