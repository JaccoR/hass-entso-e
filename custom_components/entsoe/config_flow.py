...
class EntsoeFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            user_input[CONF_EXCHANGE_RATE_ID] = 0
            ...
            if not already_configured:
                return self.async_create_entry(
                    ...
                    options={
                        ...
                        CONF_EXCHANGE_RATE_ID: user_input[CONF_EXCHANGE_RATE_ID],
                    },
                )
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(CONF_EXCHANGE_RATE_ID): EntitySelector(
                        EntitySelectorConfig(
                            domain="sensor", integration="openexchangerates"
                        )
                    ),
                }
            ),
...
class EntsoeOptionFlowHandler(OptionsFlow):
    ...
    def __init__(self, config_entry: ConfigEntry) -> None:
        ...
        self.area = None
        self.data_schema_options = vol.Schema(
            {
                vol.Required(
    ...
    async def async_step_init(
        ...
        return self.async_show_form(
            step_id="init", errors=errors, data_schema=self.data_schema_options
        )
